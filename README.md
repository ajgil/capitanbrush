...
![Capitanbrush](https://github.com/mearashadowfax/Capitanbrush/assets/125820963/cdf299bd-414a-4a2d-baf0-d188bb4709c7)

Capitanbrush is an open-source template designed for quick and efficient web project setup, blending minimalism with functionality. Whether you're showcasing a portfolio, launching a company landing page, or running a blog, Capitanbrush provides everything you need. By combining the power of the [Astro](https://astro.build/), [Tailwind CSS](https://tailwindcss.com/), and [Preline UI](https://preline.co/), this template offers a functional and aesthetically pleasing solution for your web presence.

**[View Live Demo](https://capitanbrush.es)**

## Table of Contents

* [Why Choose Capitanbrush?](#why-choose-Capitanbrush)
* [Features](#features)
...
* [x] **Internationalization (i18n) Features**:
  ...
  * Developers can access the monolingual version directly from [`monolingual-site` branch](https://github.com/mearashadowfax/Capitanbrush/tree/monolingual-site).
...
* Currently, there are no known bugs. If you encounter any issues, please report them on our [issues page](https://github.com/mearashadowfax/Capitanbrush/issues).
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmearashadowfax%2FCapitanbrush)

## Project Structure

Capitanbrush organizes modular components, content, and layouts to streamline development and content management.
...
Capitanbrush allows for easy customization to suit your specific needs. Here are a couple of ways you can configure components and content:
...
const subTitle: string =
  "At Capitanbrush, we tackle the unique challenges encountered in the hardware and construction sectors.";
```
...
The SEO Configuration in the Capitanbrush template is designed to empower users in optimizing their website's visibility on search engines and social media platforms. This documentation outlines the implementation details and usage instructions for effectively managing SEO settings.
...
This project is released under the MIT License. Please read the [LICENSE](https://github.com/mearashadowfax/Capitanbrush/blob/main/LICENSE) file for more details.
